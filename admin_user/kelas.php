...
<link href="vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    ...
    <div class="container-fluid mb-5"> 
        <div class="card-body">
            ...
            <button type="button" class="btn btn-success"><a href="?page=tambah_kelas" class="text-white">Tambah Data</a></button>
                <table class="table table-bordered mb-5" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                           <!-- tombol pemicu modal -->
                           <button class="btn btn-danger" type="button" value="" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $data['id_kelas'];?>"><i class='bx bxs-trash-alt' ></i></button>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal<?php echo $data['id_kelas'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <a href="index.php?page=edit&id_kelas=<?php echo $data['id_kelas']?>"><button type="button" class="btn btn-warning"><i class='bx bxs-edit-alt'></i></button></a></td>
                        </tr>
                        <?php
                        }
                        ?>
